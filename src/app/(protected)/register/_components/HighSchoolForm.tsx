...
const formSchema = z.object({
  ...
  interstFields: z.array(z.string()).min(1, "Please select at least one hiring field"),
})

export default function HighSchoolForm({user} : {user : {firstName : string, lastName : string, }}) {
