...
const formSchema = z.object({
  ...
  interestFields: z.array(z.string()).min(1, "Please select at least one hiring field"),
})
...
export default function StartupForm() {
  ...
  const [commandOpen, setCommandOpen] = useState(false)
    ...
    const router = useRouter()
      const createStudentUpdateUser = api.startup.createStartupUpdateUser.useMutation({
          onSuccess: () => {
